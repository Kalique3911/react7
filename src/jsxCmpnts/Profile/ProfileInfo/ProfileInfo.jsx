...
const ProfileInfo = () => {
    ...
    const {data: authUserId, isFetching: idIsFetching} = useGetAuthUserIdQuery()
    const {data: profile, isFetching: profileIsFetching} = useGetUserProfileQuery(userId ? userId : authUserId, {
